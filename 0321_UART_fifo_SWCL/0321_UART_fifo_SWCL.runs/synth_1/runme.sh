...
HD_PWD='D:/working/fpga/0323_uart_final/0321_UART_fifo_SWCL/0321_UART_fifo_SWCL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_fifo_SW_CL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart_fifo_SW_CL.tcl

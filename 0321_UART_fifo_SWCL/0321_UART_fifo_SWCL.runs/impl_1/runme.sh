...
HD_PWD='D:/working/fpga/0323_uart_final/0321_UART_fifo_SWCL/0321_UART_fifo_SWCL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_fifo_SW_CL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uart_fifo_SW_CL.tcl -notrace

...
module top_stopwatch(
    ...
    .clk(clk),
    .reset(reset),
    .i_btn_run(w_run|u_run),
    .i_btn_clear(w_clear|u_clear),
    .o_run(run),
    .o_clear(clear)
    );

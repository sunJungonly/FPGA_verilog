...
HD_PWD='D:/working/fpga/0326_DHT/0326_DHT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_sensor.tcl

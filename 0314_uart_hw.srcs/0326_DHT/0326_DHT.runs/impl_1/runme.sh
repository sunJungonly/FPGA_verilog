...
HD_PWD='D:/working/fpga/0326_DHT/0326_DHT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_sensor.tcl -notrace
